...
export default {
  ...
  methods: {
    ...
    submitData() {
      ...
      submit_data.append("quantity_id", this.data.quantity.id);
    ...
    getMainData() {
      ...
      this.$axios({
        ...
        this.quantities = res.data.data.map((item) => {
          return {
            id: item.id,
    ...
    getProduct() {
      this.$axios({
        ...
        this.data_src = res.data.data.image;
        this.data.name = res.data.data.name;

        this.data.quantity = {
          id: res.data.data.quantity.id,
          name: `${res.data.data.quantity.ar.name} - ${res.data.data.quantity.en.name}`,
        };
        this.data.category = {
