...
export default {
  ...
  data() {
    return {
      ...
      updateData: {
        // image:
        //   "https://ui.alalmiyalhura.com/omar_momen/KANAF/img/about.7c19e0b3.png",
  ...
  methods: {
    ...
    getData() {
      this.$axios({
        ...
        this.updateData.content_ar = allData.about_ar;
        this.updateData.content_en = allData.about_en;
      });
    },
    //END:: GET DATA
    ...
    validateCreateForm() {
      ...
      if (!this.updateData.content_ar) {
        ...
        data.append("about_ar", this.updateData.content_ar);
        data.append("about_en", this.updateData.content_en);
        this.$axios({
          method: "post",
          url: "setting",
          data: data,
