  ...
  methods: {
    ...
    getData() {
      this.$axios({
        ...
        this.updateData.content_ar = allData.policy_ar;
        this.updateData.content_en = allData.policy_en;
      });
    },
    //END:: GET DATA
    ...
    validateCreateForm() {
      ...
      if (!this.updateData.content_ar) {
        ...
        data.append("policy_ar", this.updateData.content_ar);
        data.append("policy_ar", this.updateData.content_en);
        this.$axios({
          method: "post",
          url: "setting",
          data: data,
          ...
          .then(() => {
            ...
            this.btnIsLoading = false;
            this.$router.push({ path: "/settings/policy" });
          })
          .catch((err) => {
            this.$iziToast.error({
              timeout: 2000,
