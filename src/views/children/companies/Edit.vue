        ...
        <div class="container">
          <div class="row justify-content-between">
            ...
            <uplode-image-2
              ...
              label="LOGO"
              :data_src="data.logo_src"
            ></uplode-image-2>
            <uplode-image-2
              @inputChanged="header_uploded"
              :data_src="data.header_src"
              label="HEADER"
            ></uplode-image-2>
            <uplode-image-2
              @inputChanged="footer_uploded"
              :data_src="data.footer_src"
              label="FOOTER"
            ></uplode-image-2>
  ...
  methods: {
    ...
    getCompaniesData() {
      this.$axios({
        ...
        this.data.logo_src = res.data.data.logo;
        this.data.header_src = res.data.data.header;
        this.data.footer_src = res.data.data.footer;
        this.data.fake_name = res.data.data.fake_name;
        this.data.nameAr = res.data.data.ar.name;
        this.data.nameEn = res.data.data.en.name;
        this.data.commercial_number = res.data.data.commercial_number;
      });
    },
    // Country
    // this.$axios({
