...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t("breadcrumb.homeFilters.all"),
          disabled: true,
          href: "",
        },
      ],
  ...
  methods: {
    ...
    // ==================== Start CRUD ====================
    addItem() {
      this.$router.push({ path: "/home_screen/homeFilters/add" });
    },
    showItem(item) {
      this.$router.push({ path: "/home_screen/homeFilters/show/" + item.id });
    },
    editItem(item) {
      this.$router.push({ path: "/home_screen/homeFilters/edit/" + item.id });
    },
    // ===== Delete
    deleteItem(item) {
