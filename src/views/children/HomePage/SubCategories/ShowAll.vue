    ...
    <main>
      ...
      >
        ...
        <template v-slot:[`item.category`]="{ item }">
          <h6>{{ item.category.ar.name }} - {{ item.category.en.name }}</h6>
        </template>
...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t("breadcrumb.SubCategories.all"),
          disabled: true,
          href: "",
        },
      ],
    ...
    headers() {
      if (this.lang == "ar") {
        return [
          ...
          //   sortable: false,
          // },
          { text: "اسم الفئة الأب", value: "category", align: "center" },
          { text: "الاسم (عربي)", value: "name_ar", align: "center" },
          {
            text: "الاسم (انجليزي)",
            value: "name_en",
            align: "center",
        ...
        return [
          ...
          //   sortable: false,
          // },
          { text: "parent Category Name", value: "category", align: "center" },
          { text: "name (arabic)", value: "name_ar", align: "center" },
          {
            text: "name (english)",
            value: "name_en",
            align: "center",
  ...
  methods: {
    ...
    // ==================== Start CRUD ====================
    addItem() {
      this.$router.push({ path: "/home_screen/SubCategories/add" });
    },
    showItem(item) {
      this.$router.push({ path: "/home_screen/SubCategories/show/" + item.id });
    },
    editItem(item) {
      this.$router.push({ path: "/home_screen/SubCategories/edit/" + item.id });
    },
    // ===== Delete
    deleteItem(item) {
    ...
    deleteItemConfirm() {
      this.$axios({
        method: "DELETE",
        url: `subCategory/${this.itemtoDelete.id}`,
      })
        .then(() => {
