...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t("breadcrumb.newCollection.title"),
          disabled: false,
          href: "/home_screen/newCollection",
        },
        {
          text: this.$t("breadcrumb.newCollection.all"),
          disabled: true,
          href: "",
        },
      ],
    ...
    headers() {
      if (this.lang == "ar") {
        return [
          ...
          { text: "العنوان (عربي)", value: "ar.name", align: "center" },
          {
            text: "العنوان (انجليزي)",
            value: "en.name",
            align: "center",
          },
          {
  ...
  methods: {
    ...
    // ==================== Start CRUD ====================
    addItem() {
      this.$router.push({ path: "/home_screen/newCollection/add" });
    },
    showItem(item) {
      this.$router.push({ path: "/home_screen/newCollection/show/" + item.id });
    },
    editItem(item) {
      this.$router.push({ path: "/home_screen/newCollection/edit/" + item.id });
    },
