...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t("breadcrumb.status.title"),
          disabled: false,
          href: "/status",
        },
        {
          text: this.$t("breadcrumb.status.all"),
          disabled: true,
          href: "",
        },
      ],
  ...
  computed: {
    ...
    headers() {
      if (this.lang == "ar") {
        return [
          {
            text: "اسم الحالة (عربي)",
            align: "center",
            value: "ar.name",
            sortable: false,
          },
          {
            text: "اسم الحالة (انجليزي)",
            align: "center",
            value: "en.name",
            sortable: false,
          },
        ...
        return [
          {
            text: "Status Name (Arabic)",
            align: "center",
            value: "title_ar",
            sortable: false,
          },
          {
            text: "Status Name (English)",
            align: "center",
            value: "title_en",
            sortable: false,
          },
  ...
  methods: {
    ...
    // ==================== Start CRUD ====================
    addItem() {
      this.$router.push({ path: "/status/add" });
    },
    editItem(item) {
      this.$router.push({ path: "/status/edit/" + item.id });
    },
    // ===== Delete
    deleteItem(item) {
    ...
    deleteItemConfirm() {
      this.$axios({
        method: "DELETE",
        url: `productStatus/${this.itemtoDelete.id}`,
      })
        .then(() => {
